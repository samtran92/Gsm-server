...
namespace _18_Jun_2021.Models
{
    ...
    public class RsaHelper
    {
        ...
        public readonly RSACryptoServiceProvider _publicKey;

        public RsaHelper()
        {
            string public_pem = System.Web.Hosting.HostingEnvironment.MapPath("~/CryptoService/posvendor.pub.pem");
            string private_pem = System.Web.Hosting.HostingEnvironment.MapPath("~/CryptoService/posvendor.key.pem");
        ...
        {
            //byte[] rgb = Encoding.UTF8.GetBytes(text);
            byte[] rgb = Zip(text);
            var encryptedBytes = _publicKey.Encrypt(rgb, false);
