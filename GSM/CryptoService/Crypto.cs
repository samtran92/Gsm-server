...
namespace _18_Jun_2021.Models
{
    ...
    public class RsaHelper
    {
        ...
        public RsaHelper()
        {
            string public_pem = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), @"..\..\CryptoService\posvendor.pub.pem");
            string private_pem = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), @"..\..\CryptoService\posvendor.key.pem");
